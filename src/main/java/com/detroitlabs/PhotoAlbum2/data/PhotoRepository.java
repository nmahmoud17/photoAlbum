...
public class PhotoRepository {
    ...
    private static final List<Photo> ALL_PHOTOS = Arrays.asList(
            ...
            new Photo("BayBridge", "Bay Bridge", LocalDate.of(2015,10,17), "USA"),
            new Photo("Bayt","Bay al-ajaib", LocalDate.of(2016,05,01),"Africa"),
            ...
            new Photo("LublubSeville","Cutest human in Seville", LocalDate.of(2018,11,20),"Europe"),
